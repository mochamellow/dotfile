...
echo ""
echo "📋 Next steps:"
echo "  1. Open nvim to install plugins automatically"
echo "  2. If using tmux, restart tmux sessions: tmux kill-server"
echo "  3. If using yabai/skhd, restart the services"
echo ""
